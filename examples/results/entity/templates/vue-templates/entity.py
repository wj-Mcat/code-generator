...
@general_bp.route('/entity/<int:entity_id>', methods=['GET'])
...
@general_bp.route('/entity/<int:entity_id>', methods=['PUT'])
...
@general_bp.route('entity/<int:entity_id>', methods=['DELETE'])
