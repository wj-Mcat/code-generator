...
@general_bp.route('/regex_extractor/<string:regex_extractor_id>', methods=['GET'])
...
@general_bp.route('/regex_extractor/<string:regex_extractor_id>', methods=['PUT'])
...
@general_bp.route('regex_extractor/<string:regex_extractor_id>', methods=['DELETE'])
def delete_regex_extractor(regex_extractor_id: str):
    """删除"""
    regex_extractor = RegexExtractor.query.filter(
        RegexExtractor.regex_extractor_id == regex_extractor_id
    ).first()
